...
globalStyle('main', {
	...
	padding: consts.space.lg,
	paddingRight: `calc(${consts.space.lg} + ${consts.pagePadding.right})`,
	paddingBottom: `calc(${consts.space.lg} + ${consts.pagePadding.bottom})`,

...
const CUSTOM_TYPE_TARGET: PartitionKind = PartitionKind::new_custom(0x41, 0).unwrap();
...
impl Partition {
    ...
    pub(super) const fn is_target(&self) -> bool {
        matches!(self.kind, CUSTOM_TYPE_TARGET)
    }
